...
const AppProvider = ({children}) => {
  ...
  const [paramLimit, setParamLimit] = useState('Repetition');
  ...
  const [savedIPAddress, setSavedIPAddress] = useState(null);
  const updateIPAddress = newValue => {
    setSavedIPAddress(newValue);
  };
